...
## 2. 무엇을 어디에 쓰나 (D34: SKILL.md 단일 정본)
...
추가되는 교리는 약 **257단어**(95 + 47 + 65 + 50)다. D34가 순감소를 강제하므로 **PR1은 SKILL.md 안에서 최소 257단어를 회수해야 한다.** 현재 SKILL.md의 장문단에 663단어가 갇혀 있으므로 (특히 line 87의 "How to apply it, in four questions" 문단과 line 91의 Authoring philosophy 문단) 재원은 있다. 단 여유가 크지 않으므로 **PR1은 SKILL.md에 대한 PR2 압축을 미리 집행한다** — 즉 SKILL.md는 PR1에서 한 번만 손대고, PR2의 10파일 목록에서 제외한다.
