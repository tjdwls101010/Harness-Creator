...
> **v2 후기(WS8)**: 2026-08-03 개정에서 `re-entry.md`가 9번째 reference로 추가됐다
> (재진입 세 모드의 절차를 `interview.md`에서 분리). 이 마일스톤 자체는 v1 완료 시점의
> 기록이므로 그대로 둔다. 현재 파일 목록은 `docs/plan/05-references-inventory.md` 참고.
