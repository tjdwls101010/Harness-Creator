...
> **개정 고지 (2026-08-01).** D1·D2·D4·D5·D6·D8·D9·D10은 [`v2/00-overview.md` §3.2](v2/00-overview.md)에서
> 개정되었고, D13-D24가 새로 추가되었다. 이 문서는 v1 구현의 역사적 기록으로 온전히 남기고, **현행 명세는
> `docs/plan/v2/`다.** v2는 Anthropic의 Claude 5 세대 컨텍스트 엔지니어링 가이드와 2026-08-01 시점의
> Claude Code v2.1.220 메커니즘에 맞춰 스킬을 개정하는 계획이다. 사실 기준은
> [`v2/research/mechanics-2026-08.md`](v2/research/mechanics-2026-08.md) — `.tmp/docs_claude/` 스냅샷
> (2026-07-05)은 이제 여러 지점에서 낡았다.
