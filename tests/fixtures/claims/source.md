...
Every rule loads at launch. A rule with `paths:` loads only on a matching read.

**Never ablate a hook.** Hooks exist for the failure you cannot observe.
...
<!-- an HTML comment is skipped too: never read, 42 -->
